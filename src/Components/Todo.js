  ...
  import { handelData, removePersnoe,hideMessage, updatePersnoe } from "../Features/todoRedux/todoReducers";
  ...
  function Myform() {
    ...
    const handelRemove=(RePersone)=>{
        dispatch(removePersnoe(RePersone));
    }
    return (
      <div>
        {show&&<Alert/>}
        ...
        <UserList data={data} handelRemove={handelRemove} handelUpdate={handelUpdate} />
      </div>
    );
  }
